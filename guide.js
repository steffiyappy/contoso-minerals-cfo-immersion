...
const labels = {
  id: {
    ...
    overview: "Briefing lintas dokumen, email, Teams dan kalender; Researcher membandingkan sumber internal dan publik; Analyst menggabungkan lima workbook. Excel menyediakan alur gabungan atau terpisah untuk selisih anggaran, komentar dan laporan bulanan. Cowork dan HR tetap dalam alur utama.",
  ...
  en: {
    ...
    overview: "Brief across documents, email, Teams and calendar; Researcher compares internal and public evidence; Analyst joins five workbooks. Excel offers combined or separate routes for budget variances, commentary and monthly reporting. Cowork and HR remain in the core flow.",
